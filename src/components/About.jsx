      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        >
          ...
          <p className="text-lg font-bold mb-8 leading-relaxed max-w-3xl text-red-50">
            ...
            . Final-year B.Tech Information Technology student with hands-on
            experience in Full Stack Development, Backend Engineering, and
            AI-powered applications.
            <br />
            <br />
            Strong foundation in Data Structures & Algorithms, RESTful API
            development, authentication systems, database design, and system
            design fundamentals. Passionate about building scalable software
            solutions that solve real-world problems and deliver meaningful user
            experiences.
            <br />
            <br />
            <span className="text-black font-black">Seeking:</span> Software
            Engineer | Full Stack Developer | AI Engineer | Backend Developer | Mern Stack Developer
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              { number: "1", label: "Internship (3 months)" },
              { number: "4+", label: "Leadership Role" },
            ].map((stat, idx) => (
              <div
                key={idx}
                className="bg-black/10 rounded-xl p-4 flex flex-col items-center justify-center border border-black/5 hover:bg-black/20 transition-colors"
              >
                <span className="text-3xl font-black text-black">
                  {stat.number}
                </span>
                <span className="text-xs font-bold text-red-50 text-center mt-1">
                  {stat.label}
                </span>
              </div>
            ))}
